...
export default function Datenschutz() {
  return (
    <>
      <Head>
        <title>Alexander Beuerle | Datenschutz</title>
      ...
      <div className="max-w-5xl	container-lg mx-auto my-8 px-8">
        <h1 className="text-3xl mb-4">Datenschutz&shy;erkl&auml;rung</h1>
        <h2 className="text-2xl my-2">1. Datenschutz auf einen Blick</h2>
        <h3 className="text-xl mb-2">Allgemeine Hinweise</h3>
        ...
        <h3 className="text-xl mb-2">Datenerfassung auf dieser Website</h3>
        ...
        <h4 className="text-lg mb-2">Wof&uuml;r nutzen wir Ihre Daten?</h4>
        <p className="text-justify">
        ...
        <h2 className="text-2xl my-2">2. Hosting</h2>
        <h3 className="text-xl mb-2">Externes Hosting</h3>
        <p className="text-justify">
        ...
        <p className="text-justify">Wir setzen folgenden Hoster ein:</p>
        <p className="text-justify">Google Firebase</p>
        <h2 className="text-2xl my-2">
          3. Allgemeine Hinweise und Pflicht&shy;informationen
        </h2>
        <h3 className="text-xl mb-2">Datenschutz</h3>
        <p className="text-justify">
        ...
        <h3 className="text-xl mb-2">Hinweis zur verantwortlichen Stelle</h3>
        <p className="text-justify">
        ...
        <h3 className="text-xl mb-2">Speicherdauer</h3>
        <p className="text-justify">
        ...
        <h3 className="text-xl mb-2">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
        <p className="text-justify">
        ...
        <h2 className="text-2xl my-2">4. Datenerfassung auf dieser Website</h2>
